...
UPDATE users SET hashed_password = $1, email = $2, updated_at = NOW() WHERE id = $3 RETURNING users.id, users.created_at, users.updated_at, users.email, users.hashed_password
`
